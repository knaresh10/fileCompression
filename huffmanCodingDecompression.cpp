...
void decompress(string &outputFileName, string& encodedData, HuffmanNode *root) {
	string decodedData = "";
	...
	ofstream decodedFile(outputFileName);
...
int main(int argc, char *argv[]) {
	...
	inputFile.close();
	decompress(outputFileName, encodedData, huffmanTree);
