...
unordered_map<char, int> getFreqTable(string &input) {
...
string getEncodedData(string &input, unordered_map<char, string>& huffmanCodes) {
	string encodedData = "";
	ifstream inputFile(input);
	char data;
...
void writeCompressedData(string &output, const string& encodedData, const unordered_map<char, string> &huffmanCodes) {
...
int main(int argc, char *argv[]) {
	...
	unordered_map<char, int> freqTable = getFreqTable(inputFile);
	HuffmanNode *huffmanTree = createHuffmanTree(freqTable);
	unordered_map<char, string> huffmanCodes;
	generateHuffmanCodes(huffmanTree, "", huffmanCodes);
	string encodedData = getEncodedData(inputFile, huffmanCodes);
	writeCompressedData(outputFile, encodedData, huffmanCodes);
